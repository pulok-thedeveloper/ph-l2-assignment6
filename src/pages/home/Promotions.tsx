        ...
        <section className="py-20 bg-gradient-to-r from-blue-600 to-purple-600">
            <div className="max-w-7xl mx-auto px-6">
                <div className="text-center text-white space-y-8">
                    ...
                    <p className="text-xl opacity-90 max-w-2xl mx-auto">Join RideAxis today and enjoy exclusive benefits for new riders. Don't miss out on these amazing deals!</p>
                    ...
                    <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
                        <div className="bg-white/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
                            <div className="space-y-4">
                                ...
                                <button className="bg-white text-blue-600 px-6 py-3 rounded-xl font-semibold hover:bg-gray-100 transition-colors w-full">Claim Offer</button>
                            </div>
                        </div>
                        ...
                        <div className="bg-background/10 backdrop-blur-sm rounded-2xl p-8 border border-white/20">
                            <div className="space-y-4">
                                ...
                                <button className="bg-white text-purple-600 px-6 py-3 rounded-xl font-semibold hover:bg-gray-100 transition-colors w-full">Get Premium</button>
                            </div>
                        </div>
                    </div>
                </div>
